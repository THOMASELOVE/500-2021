...
- Our existing `toy` and `lindner` examples
...
include_graphics("figures/austin_1.png")
```
...
# Using R for Matching: Our Examples
...
- The example uses 3 Rules I attribute to Rubin (2001) for determining when a sample comparison shows sufficient balance to allow for a reasonable regression model for the outcome. 
    - **Please read** Rubin (2001) in advance of the pre-recorded lecture for Class 6, which will mostly be about that example.
- What to do in terms of a sensitivity analysis is discussed in the final section of that example, and we'll get to that in Class 7.
...
## `cobalt` package and its update

Wyatt solved the problem that the most recent update (version 4.3.0) of `cobalt` seemed to have with some of what we were doing in the old version of the `toy` example, and we fixed that on 2021-02-25 in both the `toy` and `lindner` example.
...
Find the updated example on our 500-data page.
...
```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/hansen_1.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/hansen_2.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/hansen_3.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/hansen_4.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/hansen_5.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/hansen_6.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/hansen_7.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/hansen_8.png")
```
...
- Your Questions about the Pre-Recorded Materials
- 7 Key Aspects of Research Architecture
  - Making Fair Judgments about Causation
- Rosenbaum Chapters 5 and 6
- Planning the OSIA presentations
- Lab 3 and Project 1 Proposals both due next week

# Questions about the Pre-Recorded Material or the `dm2200` example?
...
```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/dawson_1.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/dawson_2.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/dawson_3.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/dawson_4.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/dawson_5.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/dawson_6.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/dawson_7.png")
```

---

```{r, echo = FALSE, fig.align = "center", out.width = '90%'}
include_graphics("figures/dawson_8.png")
```
...
- Project Proposal due Tuesday to Canvas (9 PM)
- Rosenbaum Chapters 5 and 6
- Planning for OSIA work
    - Identifying second readers (Survey due Tues 9 PM)
    - How to organize the sessions after Class 08
- Lab 3 setup (due next time - see next slide)

## Lab 3

In Lab 3, working with data I've provided, you will:

1. Produce unadjusted estimates of treatment effects on two binary outcomes.
2. Fit a propensity score model
3. Evaluate Rubin's Rules 1 and 2 (again, more discussion on this next week)
4. Use direct adjustment for the linear propensity score
5. Use subclassification on the propensity score
6. Perform a 1:1 greedy match without replacement
7. Compare the estimates from tasks 1, 4, 5 and 6.

Lab 4 is about weighting and double-robust estimates.
