...
**Today**: No R code. **Class 04 Lecture**: Nothing but R code.
...
![](figures/schematics/slides03_001.png)

---

![](figures/schematics/slides03_002.png)

---

![](figures/schematics/slides03_003.png)

---

![](figures/schematics/slides03_004.png)

---

![](figures/schematics/slides03_005.png)
...
![](figures/gum/gum_match1.png)

---

![](figures/gum/gum_match2.png)

---

![](figures/gum/gum_match3.png)

---

![](figures/gum/gum_match4.png)

# Standardized Difference Plot (Love Plot)

---

![](figures/gum/gum_loveplot1.png)
...
![](figures/matching/overlap.png)

---

![](figures/matching/whomatches.png)
...
![](figures/schematics/slides03_011.png)

---

![](figures/schematics/slides03_012.png)
...
![](figures/schematics/slides03_021.png)

---

![](figures/schematics/slides03_022.png)

---

![](figures/schematics/slides03_023.png)

---

![](figures/schematics/slides03_024.png)

---

![](figures/schematics/slides03_025.png)

---

![](figures/schematics/slides03_026.png)

---

![](figures/schematics/slides03_027.png)


---

![](figures/schematics/slides03_028.png)
...
![](figures/schematics/sch_weight_01.png)

---

![](figures/schematics/sch_weight_02.png)


---

![](figures/schematics/sch_weight_03.png)


---

![](figures/schematics/sch_weight_04.png)


---

![](figures/schematics/sch_weight_05.png)
...
# That's the end of the pre-recorded lecture for Class 03.

## Agenda for In-class Discussions

Between 9:30 and 10:45 AM, we'll discuss, in some order:

- Your questions about today's recorded lecture
- Lab 2, and how it went
- Some points on weighting and an introduction to the Support / RHC Study
- Rosenbaum Chapter 3
- Searching for a suitable OSIA paper, and developing a claim
- Building a proposal and course project
...
knitr::include_graphics("figures/rhc_overlap.png")
```
...
- What was the most important thing you got out of Rosenbaum, Chapter 3?
- What was the most muddled, confusing thing?
...
The recorded lecture will be a walkthrough of the `toy2021` example, which is a simple simulated observational study of a treatment on three outcomes (one quantitative, one binary, and one time-to-event) which we will use to demonstrate the completion of 13 tasks using R, which include:
...
Note we have three other (more realistic) examples we'll share in time: `lindner`, `dm2200` and `rhc2021`.

## Class 04 in person session

Running from 9:30 - 10:45. Discussion of...

- your questions about the `toy` example
- Rosenbaum, Chapter 4
- a second example
- your progress to date on the course project proposal